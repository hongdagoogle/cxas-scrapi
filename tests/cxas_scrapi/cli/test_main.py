...
@mock.patch("cxas_scrapi.cli.conversations.Apps", autospec=True)
@mock.patch("cxas_scrapi.cli.conversations.ConversationHistory", autospec=True)
...
@mock.patch("cxas_scrapi.cli.deployments.Deployments", autospec=True)
...
@mock.patch("cxas_scrapi.cli.deployments.Deployments", autospec=True)
@mock.patch("cxas_scrapi.cli.deployments.app_push", autospec=True)
